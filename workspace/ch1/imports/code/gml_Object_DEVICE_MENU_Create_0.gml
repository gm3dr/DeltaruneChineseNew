...
if (TYPE == 0)
{
    scr_windowcaption(scr_84_get_lang_string("DEVICE_MENU_slash_Create_0_gml_8_0")); // CONTACT
...
if (TYPE == 1)
{
    ...
    scr_windowcaption(scr_84_get_lang_string("DEVICE_MENU_slash_Create_0_gml_17_0")); // DELTARUNE
